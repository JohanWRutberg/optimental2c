...
const Card = ({ title, imageUrl, body }: CardType) => {
  return (
    <div
      id="card-container"
      className=" rounded-md bg-[#acd5f0] text-black w-[300px] overflow-hidden shadow-[0_0px_15px_-5px_rgba(0,0,0,0.7)] hover:scale-105 border-2 hover:border-2  transition  ease-in"
    >
